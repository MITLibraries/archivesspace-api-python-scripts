...
for count, row in df.iterrows():
    ...
    aobject = requests.get(baseURL+archival_object, headers=headers, verify=verify).json()
    ...
    post = requests.post(baseURL+archival_object, headers=headers, verify=verify, data=aobject).json()
    itemLog['post'] = post
    log.append(itemLog)
